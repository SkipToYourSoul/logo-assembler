...
if __name__ == "__main__":
    base_image = Image.open('./pictures/backend/40×30.tif')
    part_image = Image.open('./pictures/icon/图标40×30_0001_防潮.tif')

    result_image = component.assemble_image(base_image, part_image, 261, 449)
    result_image.save('./pictures/result.jpg', quality=95)
    ...
    #
    # result_image.save('./jpgs/result.png', 'jpeg')
